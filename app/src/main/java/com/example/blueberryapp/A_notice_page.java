...
public class A_notice_page extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_a_notice_page);
        ...
        Log.v("A_notice_onCreate",실행);
        IV_전화기 = findViewById(R.id.IV_전화기);
        IV_전화기.setClickable(true);

        imageSwitcher = findViewById(R.id.A공지사항광고창);
        ...
        IV_사진.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(A_notice_page.this, A_main_page.class);
        ...
        BT_이용후기.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(A_notice_page.this, A_review_page.class);
                startActivity(intent);finish();
            }
        });
        ...
        BT_매거진.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(A_notice_page.this, A_magazine_page.class);
                startActivity(intent);finish();
            }
        });
        ...
        BT_질문답변.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(A_notice_page.this, A_qna_page.class);
                startActivity(intent);finish();
            }
        });
        ...
        TV_로그아웃.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(A_notice_page.this, main_page.class);
        ...
        TV_마이페이지.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(A_notice_page.this, A_my_page.class);
                startActivity(intent);finish();
            }
        });
        ...
        TV_장바구니.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(A_notice_page.this, A_basket_page.class);
                startActivity(intent);finish();
            }
        });
    }
    ...
    protected void onResume() {
        super.onResume();
        Log.v("A_notice_onResume", 실행);
    }

    @Override
    protected void onPause() {
        super.onPause();
        Log.v("A_notice_onPause", 실행);
    }

    @Override
    protected void onStop() {
        super.onStop();
        Log.v("A_notice_onStop", 실행);
