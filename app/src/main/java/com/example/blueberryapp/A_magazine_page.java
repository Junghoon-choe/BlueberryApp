...
public class A_magazine_page extends AppCompatActivity {


    private Button BT_이용후기,BT_매거진,BT_질문답변;
    private TextView TV_로그아웃,TV_마이페이지,TV_장바구니;
    private ImageView IV_사진,IV_전화기,IV_블루베리장점;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_a_magazine_page);
        ...
        Log.v("A_magazine_onCreate",실행);
        IV_전화기 = findViewById(R.id.IV_전화기);

        imageSwitcher = findViewById(R.id.A매거진광고창);
        ...
        IV_사진.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(A_magazine_page.this, A_main_page.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        BT_이용후기.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(A_magazine_page.this, A_review_page.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        BT_매거진.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(A_magazine_page.this, A_magazine_page.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        BT_질문답변.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(A_magazine_page.this, A_qna_page.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        TV_로그아웃.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(A_magazine_page.this, main_page.class);
        ...
        TV_마이페이지.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(A_magazine_page.this, A_my_page.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        TV_장바구니.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(A_magazine_page.this, A_basket_page.class);
                startActivity(intent);
                finish();
            }
        });
    ...
    protected void onResume() {
        super.onResume();
        Log.v("A_magazine_onResume", 실행);
    }

    @Override
    protected void onPause() {
        super.onPause();
        Log.v("A_magazine_onPause", 실행);
    }

    @Override
    protected void onStop() {
        super.onStop();
        Log.v("A_magazine_onStop", 실행);
