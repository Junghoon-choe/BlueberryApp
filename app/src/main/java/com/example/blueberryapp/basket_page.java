...
public class basket_page extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*
저장된 제이손 어레이 스트링을 불러온다
제이손 어레이 스트링을 제이손 어레이 객체로 바꾼다
제이손 어레아 객체에 새로운 아이템을 에드 한다
새로운 아이템이 추가된 제이손 어레이 객체를 스트링으로 바꾼다
바뀐 제이손 어레이 스트링을 쉐어드에 저장한다
*/
        ...
        Log.v("basket_onCreate", 실행);
        IV_전화기 = findViewById(R.id.IV_전화기);
        imageSwitcher = findViewById(R.id.장바구니광고창);
        ...
        IV_사진.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(basket_page.this, main_page.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        BT_이용후기.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(basket_page.this, review_page.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        BT_매거진.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(basket_page.this, magazine_page.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        BT_질문답변.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(basket_page.this, qna_page.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        TV_로그인.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(basket_page.this, Login_Page.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        TV_회원가입.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(basket_page.this, signup_page1.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        TV_장바구니.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(basket_page.this, basket_page.class);
                startActivity(intent);
                finish();
            }
        });
    ...
    protected void onResume() {
        super.onResume();
        Log.v("basket_onResume", 실행);
    }

    @Override
    protected void onPause() {
        super.onPause();
        Log.v("basket_onPause", 실행);
    }

    @Override
    protected void onStop() {
        super.onStop();
        Log.v("basket_onStop", 실행);
